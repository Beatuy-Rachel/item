...
import { Moon, Download, Upload, RotateCcw, ChevronRight, Database } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-ink-800 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg font-semibold text-ink-800 dark:text-cream-100">用心记录</h2>
